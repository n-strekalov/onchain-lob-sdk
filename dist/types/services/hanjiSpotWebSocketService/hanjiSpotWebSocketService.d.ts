...
import { HanjiWebSocketClient, type HanjiWebSocketResponseDto, type PublicEventEmitter } from '../../common';
 ...
 */
export declare class HanjiSpotWebSocketService implements Disposable {
     ...
     */
    protected startHanjiWebSocketClientIfNeeded(): void;
    /**
     * Handles incoming WebSocket messages and emits the appropriate events.
     * @param message - The WebSocket message received.
     */
    protected readonly onSocketMessageReceived: (message: HanjiWebSocketResponseDto) => void;
}
export {};
